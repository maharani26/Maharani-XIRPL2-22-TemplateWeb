	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?= base_url()?>index.php" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						...
						<li><a href="<?= base_url()?>notifications.php" class="active"><i class="lnr lnr-alarm"></i> <span>Notifications</span></a></li>
						<li>
